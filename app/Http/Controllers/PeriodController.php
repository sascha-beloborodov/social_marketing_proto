...
class PeriodController extends AppBaseController
{
    ...
    {
        return $periodDataTable->render('templates.periods.index');
    }
    ...
    {
        return view('templates.periods.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('templates.periods.show')->with('period', $period);
    }
    ...
    public function edit($id)
    {
        ...
        return view('templates.periods.edit')->with('period', $period);
    }
